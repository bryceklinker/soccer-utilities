import { getAsyncActionSetBaseType, isFailedAction, isSuccessAction } from '../../state/create-async-action-set';
import { AnyAction } from 'redux';
import { ErrorsState } from './errors-state';

export const errorsInitialState: ErrorsState = {};

export function errorsReducer(state: ErrorsState | undefined = errorsInitialState, action: AnyAction): ErrorsState {
