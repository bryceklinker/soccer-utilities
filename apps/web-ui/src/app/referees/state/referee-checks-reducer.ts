...
export const refereeChecksReducer = createReducer<RefereeChecksState>(
  initialState,
  (builder) =>
    builder
      ...
      .addCase(RefereesActions.loadChecks.failed, (state) => ({
        ...state,
        hasBeenLoaded: true,
      }))
      .addCase(RefereesActions.checkWritten, (state, { payload }) =>
